...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "glass-card inline-flex h-12 items-center justify-center p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
